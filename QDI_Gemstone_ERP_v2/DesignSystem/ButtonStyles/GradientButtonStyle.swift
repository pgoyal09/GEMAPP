...
struct GradientButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .shadow(color: AppColors.primary.opacity(configuration.isPressed ? AppOpacity.subtle : AppOpacity.muted), radius: configuration.isPressed ? 4 : 8, y: configuration.isPressed ? 2 : 4)
