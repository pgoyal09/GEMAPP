...
/// Standardised column widths for inventory and transaction tables.
enum TableColumn {
    ...
    static let customer: CGFloat = 140
    static let memo: CGFloat = 100
    static let invoice: CGFloat = 100
